...
class SaleOrder(models.Model):
    ...
    # if the order quantity is less than the 'Maximum Order Quantity' of the Product.
    @api.one
        ...
        for record in self:
            if record.order_line:
                for product_ids in record.order_line:
                    ...
                    maximum_order_qty = self.env['product.product'].browse(product).maximum_order_quantity 
